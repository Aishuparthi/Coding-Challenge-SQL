...
TRUNCATE TABLE Orders;INSERT INTO Books (BookID, Title, Author, ISBN, Price) VALUES
(1, 'The Alchemist', 'Paulo Coelho', 'ISBN001', 499.00),
(2, 'Atomic Habits', 'James Clear', 'ISBN002', 650.00),
(3, 'Rich Dad Poor Dad', 'Robert Kiyosaki', 'ISBN003', 399.00),
(4, 'Ikigai', 'Héctor García', 'ISBN004', 299.00),
(5, 'Deep Work', 'Cal Newport', 'ISBN005', 550.00);
SELECT * FROM Books;
UPDATE Books
SET Price = 600.00
WHERE BookID = 3;
